...
public class ExcelToFoConverter extends AbstractExcelConverter
{
    ...
    {
        final Workbook workbook = ExcelToFoUtils.loadXls( xlsFile );
    ...
    protected void processCellStyle( Workbook workbook, CellStyle cellStyle, Element cellTarget, Element blockTarget )
    {
    ...
    protected void processCellStyleBorder( Workbook workbook,
    ...
    protected void processCellStyleFont( Workbook workbook, Element blockTarget, Font font )
    {
        ...
        if (workbook instanceof HSSFWorkbook) {
            ...
            XSSFCellStyle xssfCellStyle = ((XSSFWorkbook)workbook).createCellStyle();
            xssfCellStyle.setFillBackgroundColor(font.getColor());
            xssfCellStyle.setFillPattern(CellStyle.SOLID_FOREGROUND);
            fontColor = xssfCellStyle.getFillForegroundXSSFColor();
        }
     ...
     */
    protected float processColumnWidths( Sheet sheet, int maxSheetColumns,
            Element table )
    {
        float tableWidth = 0;
     ...
     */
    protected int processRow( Workbook workbook, CellRangeAddress[][] mergedRanges, Row row, Element tableRowElement )
    {
    ...
    protected Element processRowNumber( Row row )
    {
    ...
    protected float processSheet( Workbook workbook, Sheet sheet, Element flow )
    {
     ...
     *         otherwise
     */
    protected boolean processSheet( Workbook workbook, int sheetIndex )
    {
    ...
    protected void processSheetName( Sheet sheet, Element flow )
    {
